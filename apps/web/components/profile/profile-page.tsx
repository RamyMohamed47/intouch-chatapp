...
export function ProfilePage() {
  ...
  useEffect(() => {
    setCallNotifications(callNotificationsEnabled());
  }, []);
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1 text-sm leading-6 text-muted-foreground">
                  Alert this browser about incoming calls while InTouch is open
                  in a hidden tab. This is not an offline push notification.
                </p>
                <Button
                  type="button"
                  ...
                  onClick={() => {
                    ...
                    void enableCallNotifications()
                      .then(() => setCallNotifications(true))
                      .catch((error: unknown) => {
